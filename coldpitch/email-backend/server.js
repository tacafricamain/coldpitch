...
app.post('/api/send-credentials', async (req, res) => {
  try {
    ...
    const msg = {
      to: to,
      from: process.env.SENDER_EMAIL || 'noreply@spex.com.ng', // Must be verified in SendGrid!
...
app.listen(PORT, () => {
  console.log(`
  ========================================
  📧 Email Backend Server Running
  ========================================
  Port: ${PORT}
  Health: http://localhost:${PORT}/health
  API: http://localhost:${PORT}/api/send-credentials
